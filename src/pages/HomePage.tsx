...
const HomePage: React.FC<HomePageProps> = ({ serviceData }) => {
    ...
    return (
        <>
            <SEO
                title="Сервісний центр 'Техноплюс' | Ремонт техніки у Львові"
                description="Ремонт телефонів, ноутбуків, телевізорів, кавомашин та побутової техніки у Львові. Діагностика, якісні запчастини, гарантія на роботи."
                keywords="ремонт техніки львів, сервісний центр львів, ремонт телефонів, ремонт ноутбуків, ремонт побутової техніки"
