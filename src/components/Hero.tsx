        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <Reveal className="text-center lg:text-left">
            ...
            <p className="text-lg lg:text-xl text-neutral-600 mb-8 leading-relaxed">
              Ремонтуємо смартфони, ноутбуки, ПК, портативні колонки, навушники та кавові апарати. Проводимо чистку і профілактику техніки, а також повний апгрейд комп'ютерів. Швидка діагностика та надійна гарантія на всі роботи.
            </p>
