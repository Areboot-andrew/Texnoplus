...
function generateLlms() {
  ...
  content += `## Наші переваги (Чому варто обрати Техно-Плюс)\n`;
  content += `Ми круті, і ось чому:\n`;
  content += `- **Безкоштовна діагностика**: за умови погодження на ремонт ми не беремо грошей за огляд.\n`;
  content += `- **Складний компонентний ремонт**: відновлюємо материнські плати, ремонтуємо після залиття водою, беремось за те, від чого відмовляються інші.\n`;
  content += `- **Прозоре ціноутворення**: ми завжди погоджуємо остаточну вартість робіт з клієнтом **ДО** початку ремонту. Ніяких прихованих платежів.\n`;
  content += `- **Гарантія якості**: надаємо гарантію на всі виконані роботи та встановлені запчастини.\n`;
  content += `- **Оперативність**: маємо власний склад ходових запчастин для швидкого ремонту.\n`;
  content += `- **Зручний сервіс**: клієнти можуть відстежувати статус свого ремонту онлайн (за номером квитанції) та консультуватися через нашого Telegram-бота.\n\n`;
