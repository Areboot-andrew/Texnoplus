...
function generateLlms() {
  ...
  content += `Техно-Плюс — це надійний сервісний центр з ремонту техніки, розташований у Львові. Ми спеціалізуємось на ремонті смартфонів, комп'ютерів, телевізорів, дрібної побутової техніки, зарядних станцій, кавомашин та портативної акустики.\n\n`;
